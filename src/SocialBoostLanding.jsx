...
const SocialBoostLanding = () => {
  ...
  const rawBoosterServices = [
    ...
    { title: "Instagram Comment Random", price1k: 35000, price500: 19500 },
    { title: "Instagram Comment Custom", price1k: 35000, price500: 19500 },
    { title: "Instagram Comment Custom (Buzzer)", price1k: 350000, price500: 177000 },
    { title: "Instagram Share", price1k: 15000, price500: 9500 },
    { title: "Instagram Save", price1k: 3000, price500: 1500 },
    { title: "Instagram Profile Visit / Highlights", price1k: 10000, price500: 7000 },
    ...
    { title: "Facebook Comment Random", price1k: 40000, price500: 22000 },
    { title: "Facebook Comment Custom", price1k: 40000, price500: 22000 },
    { title: "Facebook Share", price1k: 30000, price500: 17000 },
    { title: "Facebook Video Views", price1k: 10000, price500: 7000 },
    { title: "Facebook Reels Views", price1k: 10000, price500: 7000 },
    { title: "Facebook Story Views", price1k: 18000, price500: 11000 },
    { title: "Facebook Live Stream Views (30 Menit)", price1k: 75000, price500: null },
    { title: "Facebook Live Stream Likes", price1k: 30000, price500: 17000 },
    { title: "Facebook Watch Time", price1k: 100000, price500: 52000 },
    
    // Twitter
    { title: "Twitter Follower", price1k: 200000, price500: 102000 },
    { title: "Twitter Likes", price1k: 80000, price500: 42000 },
    { title: "Twitter Views", price1k: 5000, price500: 4500 },
    ...
    { title: "TikTok Comments (Custom/Random)", price1k: 60000, price500: 32000 },
    { title: "TikTok Share", price1k: 15000, price500: 9500 },
    { title: "TikTok Saves", price1k: 5000, price500: 2500 },
    { title: "TikTok PK Battle Point", price1k: 10000, price500: 6000 },
    { title: "TikTok Live Stream Views (15 Menit)", price1k: 55000, price500: null },
    { title: "TikTok Live Stream Likes", price1k: 4000, price500: 2000 },
    { title: "TikTok Live Stream Comments", price1k: 45000, price500: 24500 },
    
    // Telegram
    { title: "Telegram Members", price1k: 25000, price500: 14500 },
    { title: "Telegram Post Views", price1k: 4000, price500: 2000 },
    { title: "Telegram Reactions", price1k: 4000, price500: 2000 },
    
    // YouTube
    { title: "Youtube Subscribers", price1k: 400000, price500: 202000 },
    { title: "Youtube Views", price1k: 35000, price500: 19500 },
    { title: "Youtube Likes", price1k: 20000, price500: 12000 },
    { title: "Youtube Share", price1k: 45000, price500: 24500 },
    { title: "Youtube Comment Custom", price1k: 80000, price500: 42000 },
    { title: "Youtube Live Streaming Comment", price1k: 150000, price500: 77000 },
    ...
    { title: "Shopee Live Streaming Comments", price1k: 550000, price500: 277000 },
    { title: "Shopee Likes Produk", price1k: 25000, price500: 14500 },
    { title: "Shopee Likes Video", price1k: 35000, price500: 19500 },
    { title: "Shopee Live Streaming Views (15 Menit)", price1k: 60000, price500: null },
    
    // Lazada
    { title: "Lazada Followers Indonesia", price1k: 1300000, price500: 652000 },
    
    // WhatsApp
    { title: "Whatsapp Global Channel Member", price1k: 80000, price500: 42000 },
    
    // LinkedIn
    { title: "Linkedin Post Likes", price1k: 250000, price500: 127000 },
    { title: "Linkedin Profile/Company Followers", price1k: 400000, price500: 202000 },
    { title: "LinkedIn Connections", price1k: 400000, price500: 202000 },
    
    // Spotify
    { title: "Spotify Followers", price1k: 20000, price500: 12000 },
    { title: "Spotify Plays", price1k: 15000, price500: 9500 },
    { title: "Spotify Saves", price1k: 20000, price500: 12000 },
    
    // Website
    { title: "Website Mobile Traffic", price1k: 45000, price500: 24500 },
    { title: "Website Traffic by Referrer", price1k: 20000, price500: 12000 },
    { title: "Website Traffic from Indonesia", price1k: 25000, price500: 14500 },
  ];
  ...
  const rawPremiumData = [
    ...
    { title: "Sedang dalam maintenance, data premium services akan segera diperbarui", variant: "Capcut, chatgpt, gemini, netflix, canva dan akun premiun lainya", price: 0 },
    // { title: "CANVA PRO", variant: "Famhead 1 pcs, 1 Bulan", price: 15000 },
    // { title: "CANVA PRO", variant: "Famhead 5 pcs 1 Bulan", price: 25000 },
    // { title: "CAPCUT PRO INDIVIDUAL", variant: "180 Hari", price: 215000 },
    // { title: "CAPCUT PRO TEAM", variant: "35 Hari", price: 53000 },
    // { title: "CAPCUT PRO TEAM", variant: "7 Hari", price: 15000 },
    ...
    // { title: "CHATGPT SHARING", variant: "Plus 7 Hari", price: 20000 },
    // { title: "CHATGPT SHARING", variant: "Plus 30 Hari", price: 45000 },
    // { title: "GEMINI AI", variant: "1 Tahun", price: 35000 },
    // { title: "GOOGLE DRIVE", variant: "Lifetime 1TB", price: 90000 },
    // { title: "PERPLEXITY AI", variant: "Garansi", price: 30000 },
    // { title: "PERPLEXITY AI", variant: "Tidak Garansi", price: 20000 },
    // { title: "PERPLEXITY AI", variant: "Code 1 Month", price: 15000 },
    // { title: "PICSART", variant: "30 Hari 1 pcs", price: 15000 },
    // { title: "PICSART", variant: "30 Hari 5 pcs", price: 25000 },
    // { title: "PRIME VIDEO", variant: "30 Hari 1 pcs", price: 20000 },
    // { title: "PRIME VIDEO", variant: "30 Hari 5 pcs", price: 50000 },
    // { title: "SCRIBD", variant: "Premium 30 Hari", price: 18000 },
    // { title: "SCRIBD", variant: "Basic", price: 10000 },
    // { title: "SPOTIFY PREMIUM", variant: "Link Student", price: 10000 },
    ...
    // { title: "ZOOM", variant: "14 Hari 1 pcs", price: 12000 },
    // { title: "ZOOM", variant: "14 Hari 5 pcs", price: 20000 },
    // { title: "ZOOM", variant: "30 Hari 1 pcs", price: 18000 },
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white font-sans selection:bg-purple-500 selection:text-white overflow-x-hidden">
      ...
      {/* 1. HEADER (Fixed container for Top Bar & Navbar) */}
      <header className="fixed top-0 left-0 right-0 w-full z-50">
        
        {/* STICKY TOP BAR (Reseller Promo) */}
        <div className="bg-gradient-to-r from-orange-600 to-red-600 text-white py-2.5 px-4 text-center text-xs md:text-sm font-semibold shadow-md flex items-center justify-center gap-2 flex-wrap">
          <span>🔥 Mau harga lebih murah? Gabung Reseller & Dapatkan Diskon Spesial!</span>
          <a 
            href={resellerWaLink} 
            target="_blank" 
            rel="noopener noreferrer" 
            className="bg-white text-red-600 px-3 py-0.5 rounded-full text-[10px] md:text-xs font-bold uppercase hover:bg-slate-100 transition-colors cursor-pointer"
          >
            Klik Disini
          </a>
        </div>
        ...
        <nav className="bg-slate-950/80 backdrop-blur-md border-b border-white/10 w-full">
          <div className="container mx-auto px-6 py-4 flex justify-between items-center">
            ...
            <div className="hidden md:flex items-center gap-3">
              {/* JOIN RESELLER BUTTON (New Position) */}
              <a 
                href="#reseller"
                className="text-yellow-400 font-bold hover:text-yellow-300 text-sm transition-colors border border-yellow-400/50 rounded-full px-4 py-2 hover:bg-yellow-400/10"
              >
                Join Reseller
              </a>
              ...
              <a 
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="px-6 py-2 bg-gradient-to-r from-blue-600 to-purple-600 rounded-full font-semibold hover:shadow-lg hover:shadow-purple-500/30 transition-all transform hover:-translate-y-0.5 text-sm"
              >
                Hubungi Kami
              </a>
            </div>
          ...
          {isMenuOpen && (
            <div className="md:hidden bg-slate-900 border-b border-white/10 absolute w-full">
              <div className="flex flex-col px-6 py-4 space-y-4 text-center">
                ...
                <a href="#reseller" onClick={() => setIsMenuOpen(false)} className="text-yellow-400 font-bold hover:text-yellow-300">Join Reseller</a>
      ...
      {/* Hero Section */}
      <section id="home" className="relative pt-44 pb-20 lg:pt-56 lg:pb-32 px-6 mt-16 md:mt-20">
        {/* Background Glows */}
      ...
      {/* 2. SECTION KHUSUS RESELLER (NEW) */}
      <section id="reseller" className="py-20 relative overflow-hidden">
        {/* Background Gradient */}
        <div className="absolute inset-0 bg-gradient-to-br from-slate-900 via-blue-900/20 to-slate-950 z-0"></div>
        
        <div className="container mx-auto px-6 relative z-10">
          <div className="bg-slate-900/60 border border-white/10 backdrop-blur-lg rounded-3xl p-8 md:p-12 overflow-hidden shadow-2xl">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              
              {/* Left Content */}
              <div>
                <div className="inline-flex items-center px-3 py-1 rounded-full bg-yellow-500/10 border border-yellow-500/20 text-yellow-400 text-xs font-bold mb-6">
                  <Star size={12} className="mr-2 fill-yellow-400" />
                  PELUANG BISNIS MENJANJIKAN
                </div>
                <h2 className="text-3xl md:text-5xl font-bold mb-6 leading-tight">
                  Gabung Jadi <span className="text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 to-orange-500">Reseller Resmi</span> <br />
                  Cuan Jutaan Rupiah!
                </h2>
                <p className="text-slate-400 text-lg mb-8 leading-relaxed">
                  Dapatkan akses ke harga khusus reseller yang jauh lebih murah. Cocok untuk Anda yang ingin membuka jasa sosial media sendiri tanpa ribet.
                </p>
                ...
                <div className="space-y-4 mb-8">
                  {[
                    ...
                    <div key={i} className="flex items-center text-slate-300">
                      <div className="w-8 h-8 rounded-full bg-blue-500/20 flex items-center justify-center text-blue-400 mr-4 shrink-0">
                        {item.icon}
                      </div>
                ...
                <a 
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center px-8 py-4 bg-gradient-to-r from-blue-600 to-purple-600 rounded-xl font-bold text-lg hover:shadow-lg hover:shadow-blue-500/25 transition-all transform hover:-translate-y-1"
                >
                  Daftar Reseller Sekarang <ArrowRight className="ml-2" size={20} />
                </a>
              </div>

              {/* Right Content / Visual */}
              <div className="relative hidden lg:block">
                <div className="absolute inset-0 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full blur-[80px] opacity-20 animate-pulse"></div>
                <div className="bg-slate-800/50 border border-white/10 rounded-2xl p-8 relative z-10 backdrop-blur-xl transform rotate-3 hover:rotate-0 transition-transform duration-500">
                  <div className="flex justify-between items-center mb-8 border-b border-white/5 pb-4">
                    <h3 className="font-bold text-xl">Skema Reseller</h3>
                    <span className="text-xs text-slate-400">Tanpa Risiko</span>
                  </div>
                  
                  <div className="space-y-6">
                    <div className="flex justify-between items-center">
                      <div className="text-sm text-slate-400">Biaya Pendaftaran</div>
                      <div className="font-bold text-green-400 bg-green-400/10 px-3 py-1 rounded-full text-sm">GRATIS</div>
                    </div>
                    <div className="flex justify-between items-center">
                      <div className="text-sm text-slate-400">Modal Deposit Awal</div>
                      <div className="font-bold text-green-400">Rp 0 (Tidak Perlu)</div>
                    </div>
                    <div className="h-px bg-white/10 my-4"></div>
                    <div className="flex justify-between items-center">
                      <div className="font-bold text-white">Margin Keuntungan</div>
                      <div className="font-bold text-xl text-yellow-400">Bebas Atur Sendiri</div>
                    </div>
                  </div>
                  
                  <div className="mt-8 bg-blue-500/10 p-4 rounded-xl border border-blue-500/20 text-center">
                    <p className="text-sm text-blue-300 font-medium">
                      "Cukup promosikan, kami yang kerjakan. Anda terima untung bersih!"
                    </p>
                  </div>
                </div>
              </div>
      ...
      {/* Testimonials */}
      <section id="testimoni" className="py-20 bg-slate-900 border-t border-white/5">
        <div className="container mx-auto px-6">
